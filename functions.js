...
var str = ['i','aM','using','viSual sTudio','cOde eDitor.'];
...
//to Uppercase case using IIFE

var str1 = ['i','aM','uSing','vS','code editor.'];
...
//I Am Using Vs Code editor.
 ...
 let str2 = ["visual", "studio", "code", "editor","is","good"];
...
//output
//Visual Studio Code Editor Is Good
...
var arr =["qwe", "wow", "noon", "deed", "paper"];
...
(function(){
    var arr1 =["qwe", "wow", "noon", "deed", "paper"];
    var N1=arr1.length;
    var out =[];
